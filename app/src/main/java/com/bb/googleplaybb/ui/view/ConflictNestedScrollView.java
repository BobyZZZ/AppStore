...
/**
 * Created by Boby on 2019/5/29.
 */

public class ConflictNestedScrollView extends FrameLayout implements NestedScrollingParent,
     ...
     *
     * @see #setOnScrollChangeListener(ConflictNestedScrollView.OnScrollChangeListener)
     */
    public interface OnScrollChangeListener {
         ...
         */
        void onScrollChange(ConflictNestedScrollView v, int scrollX, int scrollY,
    ...
    private ConflictNestedScrollView.SavedState mSavedState;

    private static final ConflictNestedScrollView.AccessibilityDelegate ACCESSIBILITY_DELEGATE = new ConflictNestedScrollView.AccessibilityDelegate();
    ...
    private ConflictNestedScrollView.OnScrollChangeListener mOnScrollChangeListener;

    public ConflictNestedScrollView(@NonNull Context context) {
        this(context, null);
    }

    public ConflictNestedScrollView(@NonNull Context context, @Nullable AttributeSet attrs) {
     ...
     */
    public void setOnScrollChangeListener(@Nullable ConflictNestedScrollView.OnScrollChangeListener l) {
...
//                mIsBeingDragged = !mScroller.isFinished();
    ...
    protected void onRestoreInstanceState(Parcelable state) {
        if (!(state instanceof ConflictNestedScrollView.SavedState)) {
            super.onRestoreInstanceState(state);
            return;
        }

        ConflictNestedScrollView.SavedState ss = (ConflictNestedScrollView.SavedState) state;
    ...
    protected Parcelable onSaveInstanceState() {
        ...
        ConflictNestedScrollView.SavedState ss = new ConflictNestedScrollView.SavedState(superState);
    ...
    static class SavedState extends BaseSavedState {
        ...
        public static final Parcelable.Creator<ConflictNestedScrollView.SavedState> CREATOR =
                new Parcelable.Creator<ConflictNestedScrollView.SavedState>() {
                    @Override
                    public ConflictNestedScrollView.SavedState createFromParcel(Parcel in) {
                        return new ConflictNestedScrollView.SavedState(in);
                    }

                    @Override
                    public ConflictNestedScrollView.SavedState[] newArray(int size) {
                        return new ConflictNestedScrollView.SavedState[size];
                    }
                };
    }
    ...
    static class AccessibilityDelegate extends AccessibilityDelegateCompat {
        ...
        public boolean performAccessibilityAction(View host, int action, Bundle arguments) {
            ...
            final ConflictNestedScrollView nsvHost = (ConflictNestedScrollView) host;
